...
class USVDataset(BaseDataset):  # 데이터셋 클래스 유지
    ...
    odometry_benchmark["merged_output_final_1"] = [0, 25406]
    odometry_benchmark["merged_output_final_2"] = [0, 25695]
    odometry_benchmark["merged_output_final_3"] = [0, 25980]
    ...
    def __init__(self, args):
        ...
        self.datasets_train_filter["merged_output_final_2"] = [0, 25695]
        self.datasets_train_filter["merged_output_final_3"] = [0, 25980]
        self.datasets_validatation_filter['merged_output_final_1'] = [0, 25406]
...
class USVArgs:  # 클래스 이름 및 경로 수정
    path_data_base = "../dataset/sheco_data/final_data"
    ...
    cross_validation_sequences = ['merged_output_final_1']
    test_sequences = ['merged_output_final_1']
